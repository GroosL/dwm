...
static const char *fonts[]          = { "monospace:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true", "FontAwesome:pixelsize=14" };
...
static Key keys[] = {
    ...
    {MODKEY, XK_e, XK_t, spawn, SHCMD("dmenu_kb")},
    {MODKEY, XK_d, XK_e, spawn, SHCMD("dmenu_emoji")},
    {MODKEY, XK_d, XK_q, spawn, SHCMD("dmenu_power")},
    {0, -1, XK_Print, spawn, SHCMD("dmenu_scrot")},
    {MODKEY, XK_d, XK_r, spawn, SHCMD("dmenu_radio")},
    {MODKEY, XK_d, XK_f, spawn, SHCMD("dmenu_price")},
    ...
    {0, -1, XF86XK_AudioMute, spawn, SHCMD("amixer set Master toggle; kill -44 $(pidof dwmblocks)")},
    ...
    {MODKEY | ShiftMask, -1, XK_e, spawn, SHCMD("pkill X")},
};
