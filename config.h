...
static const char hp[]				= "firefox,chromium,stremio,element,whatsdesk,discord";
...
static const char *dmenucmd[] = { "dmenu_run_history", "-hp", hp, "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "st", NULL };

static const char *mutevol[] = { "/usr/bin/pactl", "set-sink-mute",   "0", "toggle",  NULL };
static const char *playpause[] = { "/usr/bin/playerctl", "next", NULL };
